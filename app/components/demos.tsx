...
const Demos = () => {
  return (
   ...
   <h1 className='m-2 font-bold text-gray-600'>choose template</h1>
    ...
    <div className="w-[400px] rounded-2xl hover:scale-105 transition-all duration-150 border-2 border-dotted border-gray-300  flex justify-center items-center  shadow-2xl h-[400px] hover:border-4 hover:border-double hover:bg-gray-600 bg-gray-700 max-md:w-[320px] m-6">
    ...
    <div className="w-[400px] hover:scale-105 transition-all duration-150 rounded-2xl border-2 border-dotted border-gray-300 flex justify-center items-center shadow-2xl hover:border-4 hover:border-double hover:bg-gray-600 h-[400px] bg-gray-700 m-6 max-md:w-[320px]">
    <Image  className='rounded-xl border-2 border-dotted border-gray-300'
    src={img2} 
    alt='resume example' 
    width={220} 
