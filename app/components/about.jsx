...
const About = () => {
  return (
    <div> <p className="bg-gradient-to-r   from-gray-400 via-[#b4b2b2] to-gray-400 text-gray-800 flex flex-row max-md:w-fit min-md:mx-7 border-2 border-gray-700 rounded-2xl m-4 p-3">
    Welcome to Quick CV!
